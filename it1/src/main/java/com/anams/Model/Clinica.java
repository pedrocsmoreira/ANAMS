...
public class Clinica {
    ...
    public void setListaTipoServicos(ArrayList<TipoServico> listaTipoServicos){
        this.listaTipoServicos = listaTipoServicos;
    }

    public ArrayList<TipoServico> getListaTipoServicos(){
        return this.listaTipoServicos;
    }
    ...
    public void setListaConvencoes(ArrayList<Convencao> listaConvencoes){
        this.listaConvencoes = listaConvencoes;
    }

    public ArrayList<Convencao> getListaConvencoes(){
        return this.listaConvencoes;
    }
